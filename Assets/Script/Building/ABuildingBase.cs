...
public abstract class ABuildingBase : MonoBehaviour
{
    ...
    [SerializeField] protected EBuildingFaction _buildinFaction = EBuildingFaction.NONE;

    [Header("Production")]
    [SerializeField] protected EUnitType _unitProduction = EUnitType.NONE;
    [SerializeField] protected int _productionRate = 0;
    [SerializeField] protected float _productionTime = 0;
    [SerializeField] protected int _productionComplete = 0;
    ...
    abstract public void ProductionRate();
